...
namespace kboopendata22.api.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BerNumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KboCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JuridicalSituation = table.Column<string>(maxLength: 3, nullable: false),
                    TypeOfEnterprise = table.Column<string>(maxLength: 1, nullable: false),
                    JuridicalForm = table.Column<string>(maxLength: 3, nullable: true),
                    StartDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KboEnterprises", x => x.Id);
                });
